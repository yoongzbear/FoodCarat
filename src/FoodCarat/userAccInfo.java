 ...
 * @author Yuna
 */
public class userAccInfo extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(userAccInfo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
